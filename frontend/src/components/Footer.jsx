...
export default function Footer() {
  ...
  return (
    <footer role="contentinfo" className="border-t border-gray-200 mt-16 bg-gray-50">
      {/* CTA Section */}
      <section className="py-12 border-b border-gray-200" aria-labelledby="footer-cta-heading">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto">
            <h2 id="footer-cta-heading" className="text-3xl md:text-4xl font-semibold text-gray-900 mb-6">
              Let's talk
            </h2>
      ...
      {/* Main Footer Content */}
      <section className="py-12" aria-labelledby="footer-content-heading">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Mohsan Ali</h3>
              </div>
              <p className="text-gray-600 max-w-xs">
                Full-stack developer crafting clean, functional web applications with precision and care.
              </p>
            </div>

            {/* Pages Navigation */}
            <nav aria-labelledby="footer-pages-heading">
              <h4 id="footer-pages-heading" className="font-semibold text-gray-900 mb-4">Pages</h4>
            ...
            <nav aria-labelledby="footer-socials-heading">
              <h4 id="footer-socials-heading" className="font-semibold text-gray-900 mb-4">Socials</h4>
              <ul className="space-y-3" role="list">
                <li>
                  <a 
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-500">
              &copy; {currentYear} Mohsan Ali. All rights reserved.
            </p>
          </div>
        </div>
      </section>
